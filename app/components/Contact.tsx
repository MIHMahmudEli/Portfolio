const contactItems = [
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.69.065-1.228-.463-1.896-.902-1.045-.684-1.636-1.107-2.648-1.773-1.169-.774-.412-1.2.253-1.896.175-.181 3.204-2.944 3.259-3.177.007-.03.014-.145-.054-.205-.069-.06-.171-.04-.244-.023-.105.024-1.768 1.127-4.99 3.3a1.444 1.444 0 0 1-.84.346c-.538 0-1.579-.293-2.353-.546-.948-.31-1.704-.477-1.637-.999.034-.27.31-.546.828-.828 3.235-1.411 5.397-2.342 6.474-2.793 3.08-1.288 3.719-1.512 4.137-1.513z"/>
      </svg>
    ),
    bg: "linear-gradient(135deg, rgba(0, 136, 204, 0.2), rgba(0, 136, 204, 0.05))",
  },
  {
